...
export default function CertificationModal({
  ...
  const certPdfUrl = `/assets/certifications/${cert.id}.pdf`;
  ...
  return createPortal(
    <AnimatePresence>
      <div
        className="fixed inset-0 z-[100] flex items-start justify-center pt-24 pb-8 px-4 sm:px-6 overflow-y-auto pointer-events-none"
      >
