      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <a href="#home" className="flex items-center gap-2 group">
            <div className="w-8 h-8 rounded-lg bg-blue-600/10 border border-blue-500/30 flex items-center justify-center text-blue-400 font-mono font-bold text-xs group-hover:bg-blue-600 group-hover:text-white transition-all">
              KS
            </div>
          ...
          <nav className="hidden md:flex items-center gap-1 bg-[#111113]/80 p-1.5 rounded-full border border-[#27272A] backdrop-blur-md">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="px-3.5 py-1.5 text-xs font-medium text-gray-300 hover:text-white hover:bg-[#27272A] rounded-full transition-all"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="hidden sm:flex items-center gap-2.5">
            <a
              ...
              className="p-2 rounded-xl bg-[#141417] hover:bg-[#27272A] border border-[#27272A] text-gray-300 hover:text-white transition-colors"
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-xs font-semibold text-white shadow-lg shadow-blue-600/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
          ...
          <div className="flex flex-col space-y-2">
            {navLinks.map((link) => (
              <a
                ...
                className="flex items-center justify-between p-3 rounded-xl bg-[#141417] hover:bg-[#27272A] text-sm text-gray-200 font-medium"
              >
                {link.label}
